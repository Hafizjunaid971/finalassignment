...
document.getElementById('biodata').innerHTML = "<h4>Fill input value whose element id first-name, last-name, email using javascript</h4>";
  var c = document.getElementById('first-name').value = "Junaid";
  var c = document.getElementById('last-name').value = "Ahmed";
  var c = document.getElementById('email').value = "Hafizjunaid971@gmail.com";
